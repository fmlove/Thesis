...
DIV15_count = ggplot(spine_counts[spine_counts$age == 'DIV15',], aes(x = cond, y = total)) + 
  ...
  labs(x = '', y = 'Number of spines in 20μm section', title = 'DIV15') +
  ylim(-1, 30) + 
...
DIV15_type_norm = ggplot(spine_counts.normalised.melt[spine_counts.normalised.melt$age == 'DIV15',], aes(x = cond, y = value)) + 
  ...
  labs(x = '', y = 'Number of spines/total spines in 20μm section', title = 'DIV15') +
  d_format + report_theme
...
DIV21_count = ggplot(spine_counts[spine_counts$age == 'DIV21',], aes(x = cond, y = total)) + 
  ...
  labs(x = '', y = 'Number of spines in 20μm section', title = 'DIV21') +
  ylim(-1, 30) + 
  d_format + report_theme
...
DIV21_type_norm = ggplot(spine_counts.normalised.melt[spine_counts.normalised.melt$age == 'DIV21',], aes(x = cond, y = value)) + 
  ...
  labs(x = '', y = 'Number of spines/total spines in 20μm section', title = 'DIV21') +
  d_format + report_theme
...
```{r spine_types_full_figure, fig.width = 16, fig.height = 22, fig.path='../figures/full/'}
schematic = image_as_ggplot(read.bitmap('C:\\Users\\fl299\\PhD\\dendrite_section_schematic.png'))
