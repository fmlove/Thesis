...
```{r GS_intensity_plot}
GS_intensity_plot = ggplot(intensities, aes(x = cond, y = intensity)) + 
  geom_dotplot(aes(fill = cond, colour = cond), binaxis = "y", stackdir = "center", position = "dodge", binwidth = 1, dotsize = 1) + 
  geom_boxplot(fill = NA, colour = 'black', outlier.color = NA, position = "dodge", width = 0.5) + 
...
```{r GS_puncta_full, fig.width = 16, fig.height = 8, fig.path = "../figures/full/"}
puncta_image = image_as_ggplot(read.bitmap(here("images/microscopy/St3Gal5/Puncta_example_116Mut26.png")))

GS_puncta_full_figure = puncta_image + GS_count_plot + GS_intensity_plot + plot_annotation(tag_levels = 'A')
