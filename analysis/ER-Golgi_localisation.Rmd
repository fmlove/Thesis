...
max_ratio_plot = ggplot(max.gc_cyto.ratio[max.gc_cyto.ratio$cond!= 'BCAP31',], aes(x = age, y = ratio_mean)) + 
...
```{r CNC_vs_i3_ratio_plot, fig.height = 6, fig.width=16}
CNC_i3_max_ratio_plot = ggplot(rbind(i3_max.gc_cyto.ratio, max.gc_cyto.ratio[max.gc_cyto.ratio$age == 'DIV3',]), aes(x = cell_type, y = ratio_mean, group = cell_type)) + 
