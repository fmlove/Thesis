...
render(here("analysis/Protrudin_spine_type_analysis.Rmd"), pdf_document(latex_engine = 'xelatex'))
render(here("analysis/Protrudin_spine_length_analysis.Rmd"), pdf_document(latex_engine = 'xelatex'))
