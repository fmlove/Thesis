...
```{r spine_lengths_full, fig.height=14, fig.width=16, fig.path = '../figures/full/', dev = 'pdf'}
...
ggsave('spine_lengths_full.pdf', plot = spine_lengths_full_plot, device = 'pdf', path = '../figures/full/', width = 16, height = 14)
```
