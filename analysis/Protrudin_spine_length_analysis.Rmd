...
knitr::opts_chunk$set(echo = TRUE, dev = 'png', message = FALSE, warning = FALSE)
...
```{r spine_lengths_full_figure, fig.height=12, fig.width=16, fig.path = '../figures/full/'}
(counts.plot + counts_confocal.plot) / (lengths.plot + lengths_confocal.plot) + plot_annotation(tag_levels = 'A')
