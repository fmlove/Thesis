...
ERGIC53_profile.csv = read.csv("C:\\Users\\fl299\\PhD\\Data\\Mine\\Confocal\\HeLa14_ERGIC53_TIFs\\intensity_profiles\\WT3_zoom.tif_profile.csv")
...
ERGIC53_profile = ggplot(ERGIC53_profile.melt, aes(x = X, y = value, group = variable)) + 
  ...
  d_format + report_theme + theme(axis.ticks.x = element_blank(), axis.text.x = element_blank())
```

```{r Golgi_grid_extended, fig.width = 16, fig.height = 22, fig.path = "../figures/full/"}
# Golgi_layout = 'AAABBB
#                 AAABBB
#                 AAABBB
#                 CCCDDD
