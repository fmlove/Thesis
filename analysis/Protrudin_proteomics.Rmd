...
all_sets = list(`Elbaz-Alon et al. 2020` = elbaz_alon$SYMBOL,#human
                   `Matsuzaki et al. 2011` = toupper(matsuzaki$SYMBOL),#mouse
...
```{r venn, fig.width=6, fig.height=6}

venn = ggvenn(all_sets, fill_color = viridis(length(all_sets)), set_name_size = 3, text_size = 6.5, show_percentage = FALSE) + report_blank
...
```{r GO_plots, fig.width = 10, fig.height = 6}
...
proteomics_full = venn + GO_plot + plot_annotation(tag_levels = 'A')
