...
```{r LC3_full, fig.width=16, fig.height=12}
LC3.layout = 'AAAAAABBBBCC
              AAAAAABBBBCC
              AAAAAABBBBCC
              AAAAAABBBBCC
              DDDDDDDEEEFF
...
LC3_full_plot = LC3_grid + LC3_profile_plot + LC3_protrusion + LC3_neuro + LC3_neuron_plot + guide_area() + plot_annotation(tag_levels = 'A') + plot_layout(design = LC3.layout, guides = 'collect')
