...
```{r}
Rab7_kymo_panel = image_as_ggplot(read.bitmap('C:\\Users\\fl299\\PhD\\Rab7_kymo_panel.png'))
```

Patchwork
```{r Rab7_full_kymographs, fig.width = 16, fig.height = 8, fig.path = "figures/full/"}
  Rab7_kymo_panel/
