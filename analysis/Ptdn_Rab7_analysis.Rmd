...
Rab7_trace_dot = ggplot(rab7.traces.df, aes(x = cond, y = traces, fill = cond)) + 
  ...
  stat_compare_means(label.y = plyr::round_any(max(rab7.traces.df$traces), 10, ceiling), size = p_fs)
...
Patchwork
```{r Rab7_full_figure, fig.width = 16, fig.height = 8, fig.path = "../figures/full/"}
  Rab7_kymo_panel/
