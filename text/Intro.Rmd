...
```{r ptdn-schematic, echo = F, fig.height = 4, fig.cap = "Schematic of protrudin showing transmembrane domains and binding motifs.  The ER lumen is to the bottom of the image.", fig.scap="Protrudin schematic"}
