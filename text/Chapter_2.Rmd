...
```{r proteomics-full-figure, fig.width = 16, fig.height = 6, fig.path = "../figures/full/", fig.cap="A) Venn diagram showing overlap between published lists of protrudin-interacting proteins. B) Top 20 hits of GO biological process enrichment, of all proteins appearing in at least two protrudin interaction sets, sorted by p-value."}
proteomics_full
```
