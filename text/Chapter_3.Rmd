...
```{r i3-ratio-plot, echo = F, fig.width=16, fig.height=10, fig.path='../figures/full/', fig.cap="A) Ratio of fluorescence intensity between Cell body and axon terminal in DIV1 i3 vs DIV3 rat cortical neurons.  (TODO - N PER CONDITION) B-E) Representative images of DIV1 i3 neurons stained for each marker.  All scale bars are 20$\\mu$m."}
...
```{r scratch-assay-full, echo = F, fig.width=16, fig.height=16, fig.path='../figures/full/', fig.cap = "Representative images of growth cones on DIV15 cortical neurons co-expressing either mCherry (A) or mCherry-protrudin (B-C) with St3Gal5-EGFP.  All scale bars are 20$\\mu$m."}
