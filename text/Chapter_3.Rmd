...
(ref:suppl-dev-cap) Fluorescence intensity of various markers in DIV3 vs DIV15 rat cortical neurons, divided into cell body or axon terminal.  All *n* = 26 or 27 cells per condition across three batches, except SLC38A1 (*n* = 18 cells, three batches).
```{r suppl-dev-grid, echo = F, fig.width=16, fig.height=12, fig.path = './figures/full/', fig.cap="", fig.scap="Marker intensity in cell bodies and axon terminals of developing cortical neurons"}
...
(ref:i3-ratio-cap) A) Ratio of fluorescence intensity between Cell body and axon terminal in DIV1 i3 vs DIV3 rat cortical neurons.  *n* = 17 or 18 i3 neurons per condition across three batches. B-E) Representative images of DIV1 i3 neurons stained for each marker.  All scale bars are 20 \textmu{}m.
...
```{r BCAP31-plot, echo = F, fig.width=16, fig.height=16, fig.path='../figures/full', fig.cap="(ref:BCAP31-cap)", fig.scap="BCAP31 localisation in protrudin-expressing neurons"}
...
```{r SURF4-plot, echo = F, fig.width=16, fig.height=16, fig.path='../figures/full', fig.cap="(ref:SURF4-cap)", fig.scap="SURF4 localisation in protrudin-expressing neurons"}
...
```{r SLC38A1-plot, echo = F, fig.width=16, fig.height=16, fig.path='../figures/full', fig.cap="(ref:SLC38A1-cap)", fig.scap="SLC38A1 localisation in protrudin-expressing neurons"}
...
```{r ERGIC53-plot, echo = F, fig.width=16, fig.height=16, fig.path='../figures/full', fig.cap="(ref:ERGIC53-cap)", fig.scap="ERGIC53 localisation in protrudin-expressing neurons"}
...
```{r St3Gal-full-figure, echo = F, fig.width=16, fig.height=8, fig.path='../figures/full/', fig.cap="(ref:St3Gal5-cap)", fig.scap="Protrudin effect on Golgi satellite (St3Gal5) transport in the distal axon"}
